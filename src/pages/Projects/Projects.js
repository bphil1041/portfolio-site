...
function Projects() {
    ...
    const projects = [
        ...
        { id: 8, name: 'RecipEase', image: project8Image, description: 'A Django App for viewing and creating recipes. Users can sign up, log in, log out, view a list of recipes, view recipe details, create new recipes, view profile information, and change password. View the cod <a href="https://github.com/bphil1041/recipe-app" target=_blank" ref=noreferrer"> on my Github</a>' },
