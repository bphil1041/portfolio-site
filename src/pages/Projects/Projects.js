...
// Import project images and sound files
...
import openSound from "../../assets/space_ui_edit.wav";
import closeSound from "../../assets/06_ui_space_toggle_off.wav";
...
function Projects() {
  ...
  const projects = [
    ...
    {
      id: 3,
      name: "myFlix (back end)",
      image: project3Image,
      description:
        'This is the server-side for the myFlix app which provides users with information about movies, directors, and genres. Users can register, update their profiles, and create a list of favorite movies. <br /><br /> Technologies used: Node.js, Express, REST API, MongoDB, JWT Authentication, Data Validation, and Heroku. <br /><br /> View the code <a href="https://github.com/bphil1041/Movie-Api" target="_blank" rel="noreferrer">on my GitHub</a>',
    },
    {
      id: 10,
      name: "Portfolio",
      ...
      description:
        'This porfolio website! Built with React, I wanted to convey my personality through this site and go for an outer space / video game vibe. View the source code <a href="https://github.com/bphil1041/portfolio-site" target="_blank" rel="referrer"> on my GitHub</a>. My favorite features are the cursor which follows users mouse inputs, and the outer space video game sound effects.',
    },
    {
      id: 9,
      name: "ColorChord",
      image: project9Image,
      description:
        'This project is a work in progress! The goal is to build a painting/music app where each brushstroke plays a note. There are twelve colors to choose from that correspond with all twelve pitches of Western music. The Front-End is built using React, Konva.js for managing the drawing canvas, Tone.js for sound generation and linking colors to musical notes, and Web Audio API for sound processing and playback. Follow along <a href="https://github.com/bphil1041/ColorChord" target="_blank" rel="noreferrer">on my GitHub</a> as I make progress!',
    },
    {
      id: 8,
      name: "RecipEase",
      image: project8Image,
      description:
        'A Django App for viewing and creating recipes. Users can sign up, log in, log out, view a list of recipes, view recipe details, create new recipes, view profile information, and change password. View the code <a href="https://github.com/bphil1041/recipe-app" target="_blank" rel="noreferrer">on my Github</a>',
    },
    {
      id: 4,
      name: "Meet App",
    ...
    },
    {
      ...
      image: project5Image,
      description:
        'A simple Pokédex application that displays basic Pokémon information that is fetched from an API.<br /><br /> Technologies used: <br />Javascript, HTML, and CSS. <br /><br /> View the code <a href="https://github.com/bphil1041/Pokedex" target="_blank" rel="noreferrer">on my GitHub.</a>',
    },
    {
      id: 6,
      name: "Chat App",
      image: project6Image,
      description:
        'A React Native Chat app that is designed to facilitate communication between users. Users can share text messages, images, and their current location. <br /><br /> View the code <a href="https://github.com/bphil1041/chat-demo" target="_blank" rel="noreferrer">on my GitHub</a>',
    },
    {
      id: 1,
  ...
  const handleProjectClick = (project) => {
    ...
    setShowModal(true);
    if (isSoundOn && openSoundRef.current) {
  ...
  useEffect(() => {
    ...
    links.forEach((link) => link.addEventListener("click", openLinkInNewTab));

    return () => {
      links.forEach((link) =>
        link.removeEventListener("click", openLinkInNewTab)
      );
    };
  }, [showModal]);
  ...
  return (
    <div className="projects-container">
      ...
      {/* Sound Elements */}
      <audio ref={openSoundRef} src={openSound} />
      <audio ref={closeSoundRef} src={closeSound} />
    </div>
  );
}
