...
function Home() {
    return (
        <div>
            ...
            <p className='about-me'>Hello! My name is Ben. I'm a web developer and musician based in Chicago. In addition to music and coding, I enjoy biking, Muay Thai, cooking, and trying to keep my plants alive.</p>
            <br></br>
